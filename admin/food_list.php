		...
		if($cat->num_rows) {
			...
			while($row = $cat->fetch_assoc()) {
				...
				$result .=  "<tr>
								...
								<td>$foodPrice</td>
								<td>$foodCat</td>
								<td><a href='food_edit.php?edit=".$id."''><i class='fas fa-edit'></i></a></td>
...
<head>
	...
	<link rel="icon" type="image/png" href="/admin/image/favicon.ico">
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
								...
								<p style="padding: 0px 20px;"><?php if($pages >= 1 && $page <= $pages) {
									for($i = 1; $i <= $pages; $i++) {
										echo ($i == $page) ? "<a href='food_list.php?page=".$i."' style='margin-left:5px; font-weight: bold; text-decoration: none; color: #e91e63;' >$i</a>  "  : " <a href='food_list.php?page=".$i."' class='btn'>$i</a> ";
									}
								} ?></p>
