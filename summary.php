...
<div class="content remove_pad" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<div class="order_holder">
			...
			<p class="summary_p">Thank you for your order <?php echo $name; ?>. Your <span>Order number</span> is: <?php echo $order_id; ?>. We will ensure that your order is delivered in time. Please it is important to take note that your order number should be kept safe</p>
