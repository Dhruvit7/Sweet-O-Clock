...
<?php 
    ...
    $id  = preg_replace("#[^0-9]#", "", $_GET['edit']);
    $_SESSION['edit_id'] = $id;
    $res = $db->query("SELECT * FROM food WHERE id = '".$id."'");
                                ...
                                <form method="post" action='edit.php' enctype="multipart/form-data">
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" autofocus name="name" class="form-control" value="<?php echo $food['food_name']?>" required />
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" id="price" class="form-control" value="<?php echo $food['food_price']?>" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="form-group">
                                                ...
                                                <select name="category" class="form-control" required>
													...
													<option value="special">Dessert</option>
												</select>
                                            </div>
                                        </div>
                                    </div>
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="txtarea" class="form-control" placeholder="Enter description here" name="desc" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" name="submit" style="background: #e91e63; border: 1px solid #e91e63" value="Update Food" class="btn btn-info btn-fill pull-right" />
